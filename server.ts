...
const SPY_QUESTIONS = [
  "وش أكثر أكلة تكرهها؟",
  "وش أكثر شيء ما تحب تسويه؟",
  "وش أكثر مدينة تكرهها؟",
  "وش أكثر فيلم تكرهه؟",
  "وش أكثر موقف محرج صار لك؟",
  "وش أكثر هواية تكرهها؟",
  "وش أكثر شيء تشتريه وأنت زعلان؟",
  "وش أكثر صفة تكرهها في نفسك؟",
  "وش أكثر شيء ما تتحمله؟",
  "وش أكثر كلمة تكره تسمعها؟",
  "وش أكثر حيوان تكرهه؟",
  "وش أكثر مكان تكره تروح له؟",
  "وش أكثر شيء يزعجك في الناس؟",
  "وش أكثر تطبيق تكرهه؟",
  "وش أكثر شيء يحزنك؟",
  "وش أكثر شيء ندمت عليه؟",
  "وش أكثر شيء تتمنى ما تعرفه؟",
  "وش أكثر شيء تكره في الشغل؟",
  "وش أكثر شيء تكره في المدرسة؟",
  "وش أكثر رياضة تكرهها؟",
  "وش أكثر فصل تكرهه؟",
  "وش أكثر مشروب تكرهه؟",
  "وش أكثر أكلة للفطور تكرهها؟",
  "وش أكثر أكلة للعشاء تكرهها؟",
  "وش أكثر وقت في اليوم تكرهه؟",
  "وش أكثر يوم في الأسبوع تكرهه؟",
  "وش أكثر لون تكرهه؟",
  "وش أكثر شيء تتمنى لو ما موجود؟",
  "وش أكثر برنامج تكرهه؟",
  "وش أكثر قناة تكرهها؟",
  "وش أكثر مسلسل تكرهه؟",
  "وش أكثر أغنية تكرهها؟",
  "وش أكثر لون ملابس تكرهه؟",
  "وش أكثر شيء تكره تشوفه؟",
  "وش أكثر شيء تكره تسمعه؟",
  "وش أكثر طقس تكرهه؟",
  "وش أكثر نوع موسيقى تكرهه؟",
  "وش أكثر مكان تكره تطل عليه؟",
  "وش أكثر عطر تكرهه؟",
  "وش أكثر لعبة تكرهها؟",
  "وش أكثر شيء تتمنى ينتهي؟",
  "وش أكثر عادة سيئة عندك؟",
  "وش أكثر وقت تحس فيه بالملل؟",
  "وش أكثر مناسبة تكرهها؟",
  "وش أكثر سؤال تكره تسمعه؟",
  "وش أكثر صورة تكرهها؟",
  "وش أكثر لغة تكرهها؟",
  "وش أكثر شيء تكره تقرأه؟",
  "وش أكثر مشهد تكرهه؟",
  "وش أكثر فلوس تندم إنك صرفتها؟",
  "وش أكثر طعام أكلته وما عجبك؟",
  "وش أكثر مكالمة تكرهها؟",
  "وش أكثر رسالة تكره تقراها؟",
  "وش أكثر زائر تكره يجيك؟",
  "وش أكثر عيلة تكره تزورها؟",
  "وش أكثر صاحب تتجنب؟",
  "وش أكثر وجه تكره تشوفه؟",
  "وش أكثر اسم تكره تسمعه؟",
  "وش أكثر لون شعر تكرهه؟",
  "وش أكثر قصة تكره تقراها؟",
  "وش أكثر طبخ تكره تأكله؟",
  "وش أكثر ضعف تتمنى تتغلب عليه؟",
  "وش أكثر فشل مررت فيه؟",
  "وش أكثر قرار تتمنى ترجع فيه؟",
  "وش أكثر نصيحة تكره تسمعها؟",
  "وش أكثر شيء تتمنى تتذكره؟",
  "وش أكثر شيء تتمنى تنساه؟",
  "وش أكثر وقت تحب تبتعد فيه؟",
  "وش أكثر شيء تحب تمشي بدونه؟",
  "وش أكثر ملابس تكره تلبسها؟",
  "وش أكثر حذاء تكرهه؟",
  "وش أكثر مشروب بارد تكرهه؟",
  "وش أكثر مشروب ساخن تكرهه؟",
  "وش أكثر أكلة أمك تكرهها؟",
  "وش أكثر شيء تحس إنه ضيع عمرك؟",
  "وش أكثر وقت تحس فيه بالوحدة؟",
  "وش أكثر إحساس تكره تحس فيه؟",
  "وش أكثر لحظة تتمنى ما تكرر؟",
  "وش أكثر نصيحة تتمنى ما تسمعها؟",
  "وش أكثر سؤال تكره تجاوب عليه؟",
  "وش أكثر معلومة تكره تعرفها؟",
  "وش أكثر خبر سيء تكره تسمعه؟",
  "وش أكثر مكان تكره تروحو؟",
  "وش أكثر وقت تكره تستيقظ فيه؟",
  "وش أكثر وقت تكره تنام فيه؟",
  "وش أكثر يوم تكره يمر عليك؟",
  "وش أكثر شهر تكره؟",
  "وش أكثر إجازة تكرهها؟",
  "وش أكثر هدية تكره تاخذها؟",
  "وش أكثر كلمة تكتبها؟",
  "وش أكثر صورة تلتقطها؟",
  "وش أكثر صوت تسمعه؟",
  "وش أكثر رائحة تكرهها؟",
  "وش أكثر طعم تكرهه؟",
  "وش أكثر شكل تكرهه؟",
  "وش أكثر لون جدران تكرهه؟",
  "وش أكثر جهاز تكرهه؟",
  "وش أكثر لعبة تكرهها؟",
  "وش أكثر كتاب تكره تقراه؟",
  "وش أكثر شركة تكرهها؟",
  "وش أكثر طريق تكرهها؟",
  "وش أكثر حي تكره تسكن فيه؟",
  "وش أكثر بلد تكره تزورها؟",
  "وش أكثر ملعب تكره تروحو؟",
  "وش أكثر مسبح تكره تروحو؟",
  "وش أكثر صالة رياضية تكره تروحو؟",
  "وش أكثر مطعم تكره تروحو؟",
  "وش أكثر كافيه تكره تروحو؟",
  "وش أكثر فطيرة تكرهها؟",
  "وش أكثر حلوى تكرهها؟",
  "وش أكثر آيسكريم تكرهه؟",
  "وش أكثر عصير تكرهه؟",
  "وش أكثر قهوة تكرهها؟",
  "وش أكثر شاي تكرهه؟",
  "وش أكثر لبن تكرهه؟",
  ...
  "وش أكثر سمك تكرهه؟",
  "وش أكثر سلطة تكرهها؟",
  "وش أكثر شوربة تكرهها؟",
  "وش أكثر بيتزا تكرهها؟",
  "وش أكثر برغر تكرهه؟",
  "وش أكثر ساندويش تكرهه؟",
  "وش أكثر كباب تكرهه؟",
  "وش أكثر مندي تكرهه؟",
  "وش أكثر مشوي تكرهه؟",
  "وش أكثر محشي تكرهها؟",
